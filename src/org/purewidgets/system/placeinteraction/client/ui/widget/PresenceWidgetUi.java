...
public class PresenceWidgetUi extends Composite {

	
	@UiTemplate("PresenceWidgetDesktop.ui.xml")
	interface ImperativeSingleOptionUiDesktopUiBinder extends UiBinder<Widget, PresenceWidgetUi> {	}
	...
	@UiTemplate("PresenceWidgetSmartphone.ui.xml")
	interface ImperativeSingleOptionUiSmartphoneUiBinder extends UiBinder<Widget, PresenceWidgetUi> {	}
