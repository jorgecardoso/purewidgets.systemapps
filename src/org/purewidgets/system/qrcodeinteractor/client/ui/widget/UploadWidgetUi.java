...
public class UploadWidgetUi extends Composite {
    ...
    //Request request = 
		//TODO: this ulr should be set in some config setting
  		 builder.requestString("http://pw-systemapps.appspot.com/filearchive/serveposturl", new AsyncCallback<String>() {
	...
	public void requestUploadUrl() {
	    ...
	    //Request request = 
	  		 builder.requestString("http://pw-systemapps.appspot.com/filearchive/serveurl?uploadId="+this.uploadId, new AsyncCallback<String>() {
